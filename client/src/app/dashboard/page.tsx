        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Update API endpoints</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium">Design system updates</p>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium">Testing phase completion</p>
